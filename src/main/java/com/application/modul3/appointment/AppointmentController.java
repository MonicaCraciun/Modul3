...
public class AppointmentController {
	...
	public List<ExemplaryDTO> getExemplariesForUserAndPeriod(@RequestBody AppointmentInfoDTO appointmentInfoDTO) {
		List<Exemplary> exemplaries = appointmentService.getExemplariesForPeriod(appointmentInfoDTO.getStartDate(),
				appointmentInfoDTO.getEndDate(), appointmentInfoDTO.getBookId());
